...
const CreateCollectionModal: React.FC<CreateCollectionModalProps> = ({ isOpen, onClose, onCreate }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="create-collection-title" className="text-xl font-bold text-brand-text mb-4">{t('createCollection.title')}</h2>
        <div className="mb-6">
          <label htmlFor="collection-name-input" className="block text-sm font-medium text-brand-text-secondary mb-1">{t('createCollection.nameLabel')}</label>
          <input
